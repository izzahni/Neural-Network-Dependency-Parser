...
from parsing import PartialParse
from parsing import get_sentence_from_graph
...
ud_indonesian = LazyCorpusLoader(
    'ud_indonesian', UniversalDependencyCorpusReader, r'.*\.conll')
...
def load_and_preprocess_data(
        data_set=ud_english, word_embedding_path='word2vec.pkl.gz', las=True,
